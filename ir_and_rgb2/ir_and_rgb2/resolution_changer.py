...
def main(**kwargs):
    ...
    HOST = '192.168.0.252' # The server's hostname or IP address
    PORT = 65432 # The port used by the server
    # create a socket to receive the control signal from the server
    ...
    # recording the previous and current signal
    prev_signal = 'stop'
    cur_signal = 'stop'
    ...
    while True:
        ...
        # when socket receives "start" signal, set recording to 1
        try:
